...
echo   Pr‚sentation:
echo.
%fBatbox% /c 0x09 &echo |set /p=".%BS%  %sTitreDuJeu% "&%fBatbox% /c 0x07 &echo est un jeu de r‚flexion.
echo   Trouvez le mot mystŠre grƒce aux indices th‚matiques ^^!
echo.
%fBatbox% /c 0x0A & echo   RŠgles du jeu: & %fBatbox% /c 0x07
echo.
echo    - Modes de jeu: Le jeu propose deux modes:
echo        * Classique: Prenez votre temps pour r‚fl‚chir.
echo        * Contre-la-montre: Vous disposez de %iTempsDeReponseEnSecondes% secondes par indice.
echo        * Note: Vous pouvez quitter une partie … tout moment en saisissant "%iValeurDeSortie%".
echo.
echo    - Difficult‚: 
echo        Le nombre d'indices varie de 3 … 5 selon la difficult‚ choisie.
echo        Chaque nouvel indice est une nouvelle chance de deviner le mot mystŠre.
echo.
echo    - Score:
echo        * +1 point par bonne r‚ponse.
echo        * -1 point par mot non trouv‚.
echo        * Le nombre d'erreurs est affich‚ … titre informatif.
echo.
echo    - Saisie et Orthographe:
echo        * Le jeu ne fait pas de distinction entre majuscules et minuscules (insensible … la casse).
echo        * Attention: L'orthographe exacte et les accents sont requis pour valider la r‚ponse ^^!
echo.
echo    Auteur: Zaibai
echo. &pause>nul|echo   Appuyez sur une touche pour revenir au menu...
goto :Menu_Mode
...
REM Extraction de batbox.exe via PowerShell
call :SUPPR_Batbox
set "hex="
	set "hex=%hex%4D534346000000001D040000000000002C000000000000000301010001000000"
	set "hex=%hex%000000004700000001000100000800000000000000001C437A4D200062617462"
	set "hex=%hex%6F782E6578650000D407ABCE030008434BBD557F681B75147F973665B3B5894D"
	set "hex=%hex%0E0B3A768355C6C0E20F8A522964B475AB4B66C8C5056430D3E692BB2CBD0B77"
	set "hex=%hex%171B717F6434016705270CEC1F433A2A8A0A4E648E3AFF584BC58158F06FFDC3"
	set "hex=%hex%E21FDAFC63FDC71FE0B6F3F3EEAE4D0AC32AA85FFAB97BEFF3DEF77DDF7BDF77"
	set "hex=%hex%69E2F91A0944D44961721CA2182B5831DA7DD580DEFDD77BE9EADEB5034B427C"
	set "hex=%hex%ED405AD52CA96C1A05333B2D4D6575DDB0A54945322BBAA4E9D2D8B3B2346DE4"
	set "hex=%hex%94C17BEF39B81523394E1417047AE2FD7DA92D6E9D4242B7203C4D5D50BA7C32"
	set "hex=%hex%DC06CE8EDF01223F5DE4EF2FC9E35FD7883ADAF76D7BFAAABFFEE823AA04FE46"
	set "hex=%hex%B1FFF21ACC97B236DE6F07FD84BABCBCDBD70BDC8AFF78A935314645EFA5DAFC"
	set "hex=%hex%28E3E1880F32FD8B23DE8AC468F12C2BBFFA4A15CAC671A43AFA6AA4F6A5F4A8"
	set "hex=%hex%93FFB49B86DFDCEC8B51A87E18FCD1C2F73F37BF711C67630FB4A43374D68DD8"
	set "hex=%hex%198D51731574ED65E174A8D18BC31DF1204C8DE550FD03F08ED80F6D844B0E35"
	set "hex=%hex%BA5D33134187C7C411253EF71A6EB123F831CE1AE0695DAC3379D925AF815C59"
	set "hex=%hex%0F0B41E69C21EFE91DBD878F3EC619BD08D79BC1EB7DDE782FB2A0BA8F77FAD8"
	set "hex=%hex%310AF7E67E762CC2516E67F7822DF63B4355372221A2D73A417DC53DC9E37BC0"
	set "hex=%hex%CF8EB001CD58C396FCEC08DB03A1C60D68BF05E7A1DC86146A5CC1736EE435E8"
	set "hex=%hex%E7EFAC6C86CFFDC0055DBEE037E40D583B5CEF64E6A4FA5E2B8F737790DD15AF"
	set "hex=%hex%2561AEABCCC45B5C0DB765E3224BDC8B660606F5525B1BFAE1BEC143B7B8C017"
	set "hex=%hex%DD6E8A72A48738521AF6F3373100603238630977DEEC61CB307F786ED1DB772A"
	set "hex=%hex%F1B6CDDBBEB1F61455829FB95315C02C174976C479DEBEC61EFDE08B1E79089B"
	set "hex=%hex%673FEF595DF931E0BC7B03B9CE0679F43AE7F6F16BEE81C6B7A13A7FAEAB45F2"
	set "hex=%hex%EE7DC0A281DCB0FBB7737CAD708C3E047E024E01F7DF17A387812F804F80EF80"
	set "hex=%hex%A338200C1C06CE14B253B9696346B5CAF9DFA3AD38A723445191E8EB488B2B42"
	set "hex=%hex%BE057CD4C655212F0117DAB83AE4F9C8DD3FAF847C7234951E1C8BC7E9F878EA"
	set "hex=%hex%C478FCF1C75C859E93C7535B7266E24422E189B4E0075AD80E982C655F928D8A"
	set "hex=%hex%9E3BC2DAB2CF2F6FDB65D598C9687ACE9861ED108A7A127806C80135E0227009"
	set "hex=%hex%B80A7C05ACFB85FF135F7CD68A2DDBB963593D5752DC73157BD4D02DA3A424F0"
	set "hex=%hex%9BBE93492B55FB886D9BDA64C5567658462BA6659849C3D26CCDD079574AC9E6"
	set "hex=%hex%7CE3845EAED85CA65C5294F25DF64DE879C3CF6517BED591568C31CD2AA3996E"
	set "hex=%hex%BA8FE0B2878131200D9C02F2A257E95FD988CAA6A6DB7977680A8A3DA5BA128B"
	set "hex=%hex%D3594DCF9A050BBA52D56C973F33A97A92659BB651FAFFFFCFECB6FE04"

powershell -NoProfile -ExecutionPolicy Bypass -Command "$h=$env:hex -replace '[^0-9A-Fa-f]',''; $b=New-Object Byte[] ($h.Length/2); for($i=0; $i -lt $h.Length; $i+=2){$b[$i/2]=[Convert]::ToByte($h.Substring($i,2),16)}; [IO.File]::WriteAllBytes('batbox.ex_', $b)"
timeout /T 1 >nul
